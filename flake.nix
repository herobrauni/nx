{
  description = "NixOS configuration for multiple servers (dynamic host discovery)";
  ...
  outputs =
    ...
    let
      ...
      hostDirs = builtins.filter (name: (builtins.readDir ./hosts)."${name}" == "directory") (
        ...
        nodes = builtins.listToAttrs (
          builtins.map (hostName: {
            ...
            value = {
              ...
              hostname = (self.hostIPs.${hostName}) self.nixosConfigurations.${hostName}.config;
